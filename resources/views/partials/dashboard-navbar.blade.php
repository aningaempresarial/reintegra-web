<div class="border-right bg-light sidebar" id="sidebar-wrapper">
    <div class="list-group list-group-flush">
        ...
        <a href="{{ url('/admin/dashboard/users') }}" class="list-group-item list-group-item-action bg-light"><img src="{{ asset('images/user-icon.png') }}" width="60px"><p>Gerenciar usuários</p></a>
        <a href="#" class="list-group-item list-group-item-action bg-light"><img src="{{ asset('images/read-icon.png') }}" width="60px"><p>Gerenciar administradores</p></a>
    </div>
</div>